...
sudo bash -c 'echo "SUBSYSTEMS==\"usb\", ATTR{idVendor}==\"12d1\", ATTR{idProduct}=\"15ca\", RUN+=\"/usr/bin/sg_raw /dev/sr0 11 06 20 00 00 00 00 00 01 00\"" >> /etc/udev/rules.d/10-HuaweiFlashCard.rules' 
